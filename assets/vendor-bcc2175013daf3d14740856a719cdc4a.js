...
return Object.keys(t.trees).reduce(function(r,n){return r[n]={name:e.getTreeName(n),path:n,files:e.orderFiles(t.trees[n])},r},{})}),file:function(e,t){return e=this.getPathFromTreeName(e),c(a(this,"files").findBy("path",e+"/"+t))},tree:function(e){return e=this.getPathFromTreeName(e),e=s(this,"trees."+e,[]),c(e)},getTreeName:function(e){var t=a(this,"config.folders")
...
Ember.run.join(null,o,u)},t._ajaxRequest(r)},"DS: RESTAdapter#makeRequest: "+o+" "+a)}}),e.default=l})
